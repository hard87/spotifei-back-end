    ...
    public partial class CriacaoBd : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "CarlosAlbertoOficial@hootmail.com.br", null, "Carlos Alberto", "0123450", 2 });
            ...
            migrationBuilder.InsertData(
                table: "Playlists",
                columns: new[] { "Id", "DataCriacao", "Nome", "NumeroMusicas", "UsuarioId" },
                values: new object[] { 1, new DateTime(2025, 11, 18, 19, 48, 50, 267, DateTimeKind.Local).AddTicks(2029), "Musicas do Carlos", 1, 1 });

            migrationBuilder.InsertData(
                table: "Musicas",
                columns: new[] { "Id", "DataPublicacao", "Descricao", "PlaylistId" },
                values: new object[] { 1, new DateTime(2025, 11, 18, 19, 48, 50, 267, DateTimeKind.Local).AddTicks(3581), "Musica do Carlos", 1 });
